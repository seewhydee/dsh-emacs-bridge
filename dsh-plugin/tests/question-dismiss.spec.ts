// dsh-emacs-bridge — Vitest specs for the web-panel question-dismiss matching.
...
describe('question-panel dismissal matching', () => {
  ...
  it('matchDismissRecord finds a match past the first record', () => {
    const records = [
      { sessionId: 's1', questionIds: ['q1'] },
      { sessionId: 's2', questionIds: ['q2'] },
      { sessionId: 's2', questionIds: ['q3'] },
    ]
    expect(matchDismissRecord(records, {
